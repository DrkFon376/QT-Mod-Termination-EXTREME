...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{				
			...
			case 'streetFinal' | 'streetCute' | 'street' :
				boyfriend.x += 40;
				boyfriend.y += 65;
				if(SONG.song.toLowerCase() == 'censory-superload' || SONG.song.toLowerCase() == 'termination'){
					dad.x -= 70;
					dad.y += 66;
					if(!Main.qtOptimisation){
						boyfriend404.x += 40;
	...
	function startCountdown():Void
	{
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
			...
			if(!Main.qtOptimisation && (SONG.song.toLowerCase()=='censory-superload' || SONG.song.toLowerCase() == 'termination')){
				dad404.dance();
				gf404.dance();
	...
	{
		if(!(SONG.song.toLowerCase() == "termination" || SONG.song.toLowerCase() == "tutorial" || SONG.song.toLowerCase() == "censory-superload")){
			trace("Sawblade Attack Error, cannot use Termination functions outside Termination, Tutorial or Censory-Superload.");
		}
		trace("HE ATACC!");
		if(state){
	...
	{
		if(!(SONG.song.toLowerCase() == "termination" || SONG.song.toLowerCase() == "tutorial" || SONG.song.toLowerCase() == "censory-superload")){
			trace("Sawblade Alert Error, cannot use Termination functions outside Termination, Tutorial or Censory-Superload.");
		}
		trace("DANGER!");
	...
	override function stepHit()
	{
		...
		//Midsong events for Termination (such as the sawblade attack)
			...
			switch (curStep)
			{
                ...
                case 624 | 1136 | 2032 | 2608 | 2672 | 3084 | 3116 | 4140 | 4204 | 4400 | 4464:
					KBATTACK_ALERT();
					KBATTACK();
				case 628 | 1140 | 2036 | 2612 | 2676 | 3088 | 3120 | 4144 | 4208 | 4404 | 4468:
					KBATTACK_ALERTDOUBLE();
				case 632 | 1144 | 2040 | 2616 | 2680 | 3092 | 3124 | 4148 | 4212 | 4408 | 4472:
					KBATTACK(true, "old/attack_alt01");
				case 635 | 1147 | 2043 | 2619 | 2683 | 3095 | 3127 | 4151 | 4215 | 4411 | 4475:
					KBATTACK();
				case 636 | 1148 | 2044 | 2620 | 2684 | 3096 | 3128 | 4152 | 4216 | 4412 | 4476:
					KBATTACK(true, "old/attack_alt02");
				...
				case 4020 | 4032 | 4064 | 4080 | 4096 | 4108 | 4128 | 4160 | 4176 | 4192 | 4224 | 4256 | 4268 | 4288 | 4324 | 4336 | 4368 | 4432 | 4496 | 4528 | 4560 | 4592 | 4656:
					KBATTACK_ALERT();
					KBATTACK();
				case 4024 | 4036 | 4068 | 4084 | 4100 | 4112 | 4132 | 4164 | 4180 | 4196 | 4228 | 4260 | 4272 | 4292 | 4328 | 4340 | 4372 | 4436 | 4500 | 4532 | 4564 | 4596 | 4660:
					KBATTACK_ALERT();
				case 4028 | 4040 | 4072 | 4088 | 4104 | 4116 | 4136 | 4168 | 4184 | 4200 | 4232 | 4264 | 4276 | 4296 | 4332 | 4344 | 4376 | 4440 | 4504 | 4536 | 4568 | 4600 | 4664:
					KBATTACK(true);
